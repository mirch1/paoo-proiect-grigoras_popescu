...
public class Tile
{
    ...
    public static Tile dungeonFloorTile = new DungeonFloorTile(5);
    public static Tile dungeonWallTile = new DungeonWallTile(6);
    public static Tile dungeonBarrelTile = new DungeonBarrelTile(7);
    public static Tile dungeonChestTile = new DungeonChestTile(8);
